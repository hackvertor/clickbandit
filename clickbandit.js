...
!function(){
	...
	function createHeader(doc, node) {
		...
		help.onclick = function() {
			...
			if(window.clickbandit.mode === 'record') {
				...
				contents += '<p>You can click the add iframe sandbox checkbox to add the sandbox attribute to the iframe, this option will allow you to avoid frame busters.</p>';
	...
	function createMenu(node) {
		...
		div.style.color = '#000';
		div.innerHTML = '<form><ul id="menu"><li><input type="checkbox" id="addIframeSandbox" onclick="if(this.checked){ window.clickbandit.sandbox = true; } else { window.clickbandit.sandbox = false; }" /> <label style="color:#000;" for="addIframeSandbox">Add iframe sandbox</label></li><li><a href="#" class="btn" onclick="clickbandit.finish();return false;">Finish</a></li></ul></form>';
	...
	window.clickbandit = {mode: 'record', finish: finish, version: "1.0.1", disableClickActions: false, sandbox: false};
